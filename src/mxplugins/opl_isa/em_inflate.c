...
/* This file has been altered from its original */
...
static unsigned int nLiteralsRevSymbolTable[NLITERALSYMS * 2];
static unsigned int nOffsetRevSymbolTable[NOFFSETSYMS * 2];
static unsigned char nCodeLength[NLITERALSYMS + NOFFSETSYMS];
static unsigned int nTablesRevSymbolTable[NCODELENSYMS * 2];
static unsigned char nFixedLiteralCodeLen[NLITERALSYMS];
static unsigned char nFixedOffsetCodeLen[NOFFSETSYMS];

static em_lsb_huffman_decoder_t literalsDecoder;
static em_lsb_huffman_decoder_t offsetDecoder;
static em_lsb_huffman_decoder_t tablesDecoder;
